    ...
    <div class="col-xs-12 col-lg-3">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            <div class="col-xs-12">
              <button type="button" class="btn btn-warning btn-block" id="settings-reset">
          ...
          <div class="form-group">
            <div class="col-xs-12">
              <button type="button" class="btn btn-danger btn-block" id="settings-purge">
...
<script type="text/javascript" src="{relative_path}/plugins/@{name}/static/adminSettings.js"></script>
